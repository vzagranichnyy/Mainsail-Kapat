import{t as e}from"./shaderStore-D-XQlhUT.js";import"./clipPlaneFragment-CSA2ud-B.js";import"./fogFragment-CDrq7NOC.js";import"./mainUVVaryingDeclaration-Ke9CHBQH.js";import"./helperFunctions-Dh90YL4s.js";import"./logDepthDeclaration--laj1kHT.js";import"./logDepthFragment-DwslsINR.js";var t=`decalFragmentDeclaration`,n=`#ifdef DECAL
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`lightsFragmentFunctions`,g=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`shadowsFragmentFunctions`,v=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`samplerFragmentDeclaration`,b=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`fresnelFunction`,S=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`reflectionFunction`,w=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T=`imageProcessingDeclaration`,E=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D=`imageProcessingFunctions`,O=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`bumpFragmentMainFunctions`,A=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`bumpFragmentFunctions`,M=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N=`bumpFragment`,P=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F=`decalFragment`,I=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`depthPrePass`,R=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`lightFragment`,B=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V=`oitFragment`,H=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var U=`defaultPixelShader`,W=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[U]||(e.ShadersStore[U]=W);var G={name:U,shader:W};export{G as defaultPixelShader};