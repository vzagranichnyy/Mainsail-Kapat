import{t as e}from"./shaderStore-D-XQlhUT.js";import"./clipPlaneFragment-DGqZJNeS.js";import"./fogFragment-BBcndHBz.js";import"./mainUVVaryingDeclaration-ufEqjvIX.js";import"./helperFunctions-DquCMwzt.js";import"./decalFragment-BXn-giAh.js";import"./logDepthDeclaration-B8O1rFmO.js";import"./logDepthFragment-ccQ8natM.js";var t=`prePassDeclaration`,n=`#ifdef PREPASS
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);var l=`lightsFragmentFunctions`,u=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var p=`samplerFragmentDeclaration`,m=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h=`reflectionFunction`,g=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var _=`imageProcessingDeclaration`,v=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var y=`imageProcessingFunctions`,b=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x=`bumpFragmentMainFunctions`,S=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var C=`bumpFragmentFunctions`,w=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=w);var T=`bumpFragment`,E=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=E);var D=`depthPrePass`,O=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k=`lightFragment`,A=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=A);var j=`oitFragment`,M=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var N=`defaultPixelShader`,P=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[N]||(e.ShadersStoreWGSL[N]=P);var F={name:N,shader:P};export{F as defaultPixelShaderWGSL};