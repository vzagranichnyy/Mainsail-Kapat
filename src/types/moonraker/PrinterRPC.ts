...
export interface PrinterRPC {
    ...
    /**
     * Execute a gcode script. The response is not returned until the script
     * has finished execution -- callers awaiting this should not apply a
     * short timeout, since commands like G28/M109 can legitimately run for
     * minutes.
     */
